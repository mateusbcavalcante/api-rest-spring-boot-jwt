...
import com.movie.api.responses.JwtAuthenticationResponse;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> createAuthenticationToken(@RequestBody(required=true) JwtAuthenticationRequest jwtAuthenticationRequest) throws AuthenticationException {
        authenticate(jwtAuthenticationRequest.getUsername(), jwtAuthenticationRequest.getPassword());
        return ResponseEntity.ok(new JwtAuthenticationResponse(authenticationService.generateTokenByUsername(jwtAuthenticationRequest.getUsername())));
    }
